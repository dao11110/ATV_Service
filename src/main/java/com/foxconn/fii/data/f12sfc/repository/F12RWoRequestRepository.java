...
public interface F12RWoRequestRepository extends JpaRepository<F12RWoRequest, Integer> {
    ...
    List<F12RWoRequest> jpqlGetPnsByWo(@Param("wo") String wo, @Param("date") Date mDate);
    ...
    List<F12RWoRequest> jpqlGetPnsByTime(@Param("date") Date mDate);
}
